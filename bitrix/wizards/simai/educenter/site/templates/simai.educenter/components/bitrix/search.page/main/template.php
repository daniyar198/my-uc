...
<?endif;?>
    <div class="col-md-4">
	<input type="submit"  class="btn btn-base" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?elseif(count($arResult["SEARCH"])>0):?>
    ...
    <div class="wp-block property list">
        <div class="wp-block-title">
            <h3><a href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a></h3></div>
        <div class="wp-block-body">
        <p class="description"><?echo $arItem["BODY_FORMATED"]?></p>
