...
if ($arSite = $obSite->Fetch())
{
	...
	$arProp = CFileMan::GetPropstypes();

	$arAddprop=array(
		   "show_left_column" => getMessage("SHOW_LEFT_COLUMN"),
		   "show_right_column" => getMessage("SHOW_RIGHT_COLUMN"),
		   "show_breadcrumb" => getMessage("SHOW_NAVIGATE"),
		   "section_name_menu" => getMessage("TITLE_SECTION_MENU"),
		   "show_title" => getMessage("SHOW_TITLE"),
	);
	CFileMan::SetPropstypes(array_merge($arAddprop,$arProp), false, WIZARD_SITE_ID);	
}
