...
/*ZDUyZmZODUzYWM3NTYxNDU2NmI4YWJlNjNlNDFhY2MzMDIwOWI=*/$GLOBALS['____830852651']= array(base64_decode('ZGVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___83587402')){function ___83587402($_860016000){static $_1993921929= false; if($_1993921929 == false) $_1993921929=array(''.'RU5'.'DT0RF',''.'WQ'.'='.'=');return base64_decode($_1993921929[$_860016000]);}};class CBXFeatures{ public static function IsFeatureEnabled($_121653246){ return true;} public static function IsFeatureEditable($_121653246){ return true;} public static function SetFeatureEnabled($_121653246, $_1656001982= true){} public static function SaveFeaturesSettings($_280493603, $_2100403787){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1682924049){} public static function ModifyFeaturesSettings($_1682924049, $_149583560){} public static function IsFeatureInstalled($_121653246){ return true;}} $GLOBALS['____830852651'][0](___83587402(0), ___83587402(1));/**/			//Do not remove this
