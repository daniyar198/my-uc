...
class CSimaiMenuComponent extends CBitrixComponent
{
	...
	public function getChildMenuRecursive(&$arMenu, &$arResult, $menuType, $submenuType, $use_ext, $menuTemplate, $currentLevel, $maxLevel, $bMultiSelect, $bCheckSelected)
	{
				...
				if($bDir)
				{
					...
					if ($subMenuExists)
					{
						...
						if(count($menu->arMenu) > 0)
							$this->GetChildMenuRecursive($menu->arMenu, $arResult, $submenuType,$submenuType, $use_ext, $menuTemplate, $currentLevel+1, $maxLevel, $bMultiSelect, $bCheckSelected);
					}
				}
			}
