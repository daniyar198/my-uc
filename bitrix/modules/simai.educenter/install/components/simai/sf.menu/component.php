...
if($this->startResultCache(false, false, ($arParams["MENU_CACHE_USE_USERS"] === "Y"? $this->getGenerationCachePath($USER->GetID()): false)))
{
	...
	/*if($arParams["SF_NAVBAR_MEGA_MODE"] === "Y")
		foreach($menu->arMenu as $key => $arItem)
			$arParams["SF_NAVBAR_MEGA_PASTE_LIST"]["VALUE"][$arItem["ITEM_INDEX"]] = $arItem["TEXT"];*/
