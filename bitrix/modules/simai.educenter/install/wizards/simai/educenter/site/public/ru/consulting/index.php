...
<?$APPLICATION->IncludeComponent("bitrix:catalog", "consulting", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"IBLOCK_ID" => "#consulting#",	// Инфоблок
		"IBLOCK_ID_FEEDBACK" => "#FEEDBACK#",	// ID инфоблока обратной связи
		"IBLOCK_ID_FILIAL" => "#branches#",
		"IBLOCK_ID_PRICE_LIST" => "#PRICE_LIST#",	// ID инфоблока прайс-листа
		"IBLOCK_REVIEWS_ID" => "",
		"IBLOCK_TYPE" => "consult",	// Тип инфоблока
		...
		"SEF_FOLDER" => "#SITEDIR#consulting/",	// Каталог ЧПУ (относительно корня сайта)
