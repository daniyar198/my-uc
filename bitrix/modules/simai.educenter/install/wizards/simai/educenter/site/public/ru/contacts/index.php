...
<div class="tabs-framed">
	<ul class="tabs clearfix">
		...
		<li class=""><a href="#tab2-2" data-toggle="tab">Филиалы</a></li>
	</ul>
			...
			<div class="contact-info">
				<ul class="list-check mb-10 mt-10 ml-0 mr-0">
					...
					<li>
						...
						<?=COption::GetOptionString($GLOBALS["moduleName"], "address", "")?>
					</li>
					<?endif?>
					<?if(COption::GetOptionString($GLOBALS["moduleName"], "phone", "")!=""):?>
					<li>
						<i class="fa fa-phone"></i>
						<?=COption::GetOptionString($GLOBALS["moduleName"], "phone", "")?>
					</li>
					<?endif?>
