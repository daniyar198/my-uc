...
<li id="cache_auth_container" class="aux-languages dropdown animate-hover" data-animate="animated fadeInUp">
    <span><a href="<?=SITE_DIR?>auth/"><?=GetMessage("AUTH_LOGIN_BUTTON")?></a><span>
...
?>
	<li class="aux-languages dropdown animate-hover" data-animate="animated fadeInUp">
		<span><a href="<?=$arResult["urlToOwnProfile"]?>"><span class="language name"><?=(strlen($arResult["USER_NAME"]) > 0 ? $arResult["USER_NAME"] : $arResult["USER_LOGIN"])?></span></a></span>
